...
export const PeopleCard = (props) => {
    ...
    const cardImg = `${process.env.REACT_APP_VISUAL_GUIDE}characters/${uid}.jpg`;
        ...
        <div className="card" style={{ "width": "18rem" }}>
            ...
            <div className="card-body text-center">
                ...
                <div className="d-flex align-items-center">
                    <Link to={`characters/${uid}`} className="flex-grow-1 me-2">
                        <button className="btn btn-primary w-100">Details</button>
                    </Link>
                    <button className="btn btn-outline-danger" onClick={() => {
                        actions.addFavourite("characters", uid, name);
                    }}>
